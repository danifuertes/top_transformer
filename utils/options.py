...
def get_options(args=None):
    ...
    # Model
    parser.add_argument('--model', default='attention', help="Model, attention (default), pointer, gpn, gamma")
    ...
    opts.save_dir = os.path.join(
        opts.output_dir,
        "{}_{}{}".format(opts.problem, opts.data_distribution, opts.graph_size) if opts.problem == 'top'
